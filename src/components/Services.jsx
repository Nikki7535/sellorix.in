    ...
    <section id="services" ref={containerRef} className="py-24 px-6 md:px-12 relative z-10 w-full">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 max-w-2xl mx-auto service-header">
          ...
          <h3 className="text-4xl md:text-5xl font-bold mb-6">Expertise that drives <span className="heading-gradient text-transparent bg-clip-text">tangible results</span></h3>
          <p className="text-gray-400 text-lg">We bring hands-on experience to solve complex challenges, ensuring your business stays ahead of the competition.</p>
        </div>
