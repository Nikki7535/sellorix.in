...
const faqs = [
  { q: "What numbers are analyzed?", a: "We dive into your key metrics including total sales, ACoS, TACoS, conversion rates, click-through rates, and inventory age to uncover exactly where you are losing money." },
  { q: "What changes if I have an account audit period?", a: "The audit highlights specific, actionable gaps in your current strategy. It acts as a customized roadmap detailing exactly what titles, campaigns, and operations need fixing." },
  { q: "How detailed is the Amazon account audit?", a: "Extremely comprehensive. It goes beyond the surface level to dissect your backend search terms, PPC bid architecture, inventory bottlenecks, and overall Brand Registry health." },
  { q: "How many sub-users will you pull data from?", a: "We typically require limited 'View Only' access as a sub-user to gather accurate data without disrupting your active operations or team workflows." },
  { q: "How will the audit help my business bottom line?", a: "By identifying wasted ad spend and uncovering suppressed listings, the audit directly pinpoints the exact actions needed to reduce overhead costs and immediately boost organic traffic." }
];
          ...
          <div className="anim-up flex flex-col items-start gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
              <input 
                type="number" 
                placeholder="0"
                className="bg-white/5 border border-white/10 rounded-xl px-6 py-3.5 text-white focus:outline-none focus:border-yellow-500/50 w-full sm:w-32 text-center text-lg font-bold"
              />
          ...
          <div className="w-full max-w-[600px] relative">
             ...
             <div className="bg-gray-800 rounded-2xl border-4 border-gray-700 p-1 flex flex-col shadow-2xl relative z-10">
                <div className="bg-gray-900 rounded-xl overflow-hidden h-64 sm:h-80 flex flex-col relative">
                   ...
                   {/* Dashboard content */}
                   <div className="flex-1 bg-[#1A202E] p-4 flex flex-col gap-3">
                      <div className="w-1/4 h-5 bg-white/10 rounded-md mb-2" />
                      <div className="grid grid-cols-3 gap-3">
                        <div className="bg-white/5 border border-white/10 h-16 rounded-lg" />
                        <div className="bg-white/5 border border-white/10 h-16 rounded-lg" />
                        <div className="bg-white/5 border border-white/10 h-16 rounded-lg" />
                      </div>
                      <div className="flex gap-3 mt-2 h-24">
                        <div className="flex-[2] bg-white/5 border border-white/10 rounded-lg" />
                        <div className="flex-1 bg-white/5 border border-white/10 rounded-lg flex flex-col justify-end p-2 gap-1 animate-pulse">
                          <div className="w-full h-1 bg-green-400 rounded-full" />
                          <div className="w-3/4 h-1 bg-yellow-400 rounded-full" />
                          <div className="w-1/2 h-1 bg-orange-400 rounded-full" />
                        </div>
                      </div>
                   </div>
                </div>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
              <input 
                type="number" 
                placeholder="0"
                className="bg-[#0E121E] border border-white/10 rounded-full px-6 py-3.5 text-white focus:outline-none focus:border-yellow-500/50 w-full sm:w-32 text-center text-lg font-bold shadow-inner shadow-black"
              />
