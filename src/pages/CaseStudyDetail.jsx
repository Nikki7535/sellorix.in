...
const CaseStudyDetail = () => {
  ...
  const tabs = [
    ...
    { 
      id: 'Year 1', 
      title: 'Year 1', 
      content: '2022 Performance: Sustained Scale. By the end of Year 1, we achieved a total revenue growth of 215% compared to the 2020 average. This was driven by a complete overhaul of the advertising strategy and inventory management protocols.' 
    },
    { 
      id: 'Year 2', 
      title: 'Year 2', 
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
          ...
          <div className="relative group perspective-1000 hidden lg:block">
            <div className="w-64 bg-dark-surface p-4 rounded-2xl shadow-2xl border border-white/10 transform group-hover:rotate-y-12 transition-transform duration-500">
              ...
              />
              <p className="text-[10px] font-black uppercase text-gray-500 mb-1 tracking-widest">Chirp</p>
              <h4 className="text-xs font-bold leading-tight mb-2 text-white/90">Back Roller Wheel for Pain Relief - Eco Friendly Sport Series</h4>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-20 flex flex-col lg:flex-row gap-16">
        ...
        <div className="flex-[2]">
          <section className="reveal-section mb-20 text-lg leading-relaxed text-gray-400">
            ...
            <p>
              Chirp founded in 2011 by Tate Stock, began by delivering a point-of-sale system to help with the 
              original Plexus Wheel. After discovering how much interest the device had effectively in back-
              pain relief. Today, the brand has helped over 100,000 customers manage daily aches and pains with 
              sustained, non-invasive therapies around the clock. Their mission remains simple: manage pain and live 
              life to the more.
            </p>
          </section>
        ...
        <div className="flex-1">
          <div className="sticky top-32 p-8 rounded-3xl bg-dark-surface border border-white/5 flex flex-col gap-8 shadow-2xl">
            <div className="text-center pb-8 border-b border-white/5">
              <h3 className="text-5xl font-black text-[#00aaff] tracking-tighter">chirp.</h3>
            </div>
            ...
            <div className="space-y-6 text-sm">
              ...
              <div className="border-t border-white/5 pt-6">
                ...
                <a href="https://gochirp.com" target="_blank" className="text-gray-500 pl-6 hover:text-primary-400 transition-colors">gochirp.com</a>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-500 pl-6">$10M - $50M</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
            ...
            <div className="reveal-section">
              ...
              <p className="text-gray-400 mb-12">Total gross revenue grew from $500k to $12.5M in four years under Sellorix management.</p>
            ...
            {/* Chart 2: Ad Spending */}
            <div className="reveal-section">
              <h3 className="text-2xl font-black text-white mb-4">Grow Ad Sales from $190k to $7.9M in four years</h3>
      ...
      <section className="py-40 text-center bg-dark-bg px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-xl text-gray-400 mb-14 max-w-2xl mx-auto font-medium leading-relaxed">
            Join the 100+ brands that have scaled their e-commerce presence with Sellorix precision.
          </p>
