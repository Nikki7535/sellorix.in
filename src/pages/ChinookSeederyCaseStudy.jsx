...
const ChinookSeederyCaseStudy = () => {
  ...
  const tabs = [
    { 
      id: 'Year 1-2', 
      title: 'Year 1-2', 
      content: '2021 Brand Setup and Security: In early 2021, the approach focused on preventing listing damage, fixing account health, and account history to refine the Amazon PPC Search Strategy with next-generation local ads like Sponsored Brand and Amazon Video Ads.' 
    },
    { 
      id: 'Year 2', 
      title: 'Year 2', 
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12 relative z-10">
          <div className="flex-1 text-center md:text-left">
            ...
            <h1 className="text-5xl md:text-8xl font-black mb-8 leading-tight tracking-tighter">
               Chinook <span className="heading-gradient">Seedery</span>
            </h1>
            <p className="text-2xl text-gray-400 leading-relaxed font-light max-w-2xl">
              Current average weekly sales are 215% higher compared to 2020 after <span className="text-white font-bold italic underline decoration-primary-500/30 underline-offset-8">MAG management</span>.
            </p>
          ...
          <div className="relative group perspective-1000 hidden lg:block stat-card">
            <div className="w-72 bg-dark-surface p-5 rounded-[32px] shadow-2xl border border-white/10 transform transition-all duration-700 hover:rotate-y-12">
              ...
              <img 
                src="https://images.unsplash.com/photo-1599420186946-7b6fb4e297f0?q=80&w=400&h=400&auto=format&fit=crop" 
                alt="Chinook Seedery Product" 
              ...
              <h4 className="text-sm font-bold leading-tight mb-4 text-white/90">Chinook Seedery Roasted Sunflower Seeds - 8 Pack Sampler Pack</h4>
              <div className="flex items-center justify-between border-t border-white/5 pt-4">
                <p className="text-xl font-black text-white">$15.95</p>
        ...
        <div className="flex-[2]">
          <section className="reveal-section mb-20" id="introduction">
            ...
            <p className="text-lg leading-relaxed text-gray-400 max-w-3xl mb-6">
              Chinook Seedery began with the idea that sunflower seeds—the perfect snack for sportsmen—should deliver 
              quality and flavor that lingers without a salt puffer taste. We brought a larger seed with a more brittle 
              shell and a crunchy kernel.
            </p>
            <p className="text-lg leading-relaxed text-gray-400 max-w-3xl">
              Chinook found a roadmap of quality and all-natural ingredients. Packed with vitamin E, minerals, and 
              healthy fats, Chinook Seeds deliver both great taste and nutrition in every bite.
            </p>
          </section>
          ...
          <div className="sticky top-32 space-y-8">
            <div className="p-10 rounded-[40px] bg-dark-surface border border-white/10 shadow-3xl">
              <div className="mb-12 text-center pb-8 border-b border-white/5">
                 <h3 className="text-4xl font-black text-white tracking-tighter">CHINOOK<span className="text-primary-500">SEEDERY</span></h3>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="pt-8 border-t border-white/5">
                   ...
                   <div className="p-6 rounded-2xl bg-white/5 border border-white/5 italic text-sm text-gray-400 leading-relaxed font-medium">
                      "MAG refined our PPC strategy and implemented season-trend tracking, leading to a 215% increase in weekly sales compared to 2020."
                   </div>
                </div>
              </div>
            </div>
