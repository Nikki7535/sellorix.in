...
const StampHubCaseStudy = () => {
  ...
  const tabs = [
    { 
      ...
      content: 'We performed a complete inventory overhaul for Stamp Hub. We audited their catalogs across 20+ categories, identified "retail hazards," and reorganized the parent/child listing structures to improve browse nodes and SEO visibility.' 
    },
    { 
      id: 'Marketing', 
    ...
    { 
      ...
      content: 'A full advertising audit led to a completely new PPC architecture. We implemented competitor-based targeting, defensive brand strategies, and precision budget allocation that scaled monthly revenue from $24k to $96k within the first year.' 
    },
    { 
      id: 'Account', 
  ...
  return (
    <div className="pt-24 min-h-screen bg-dark-bg text-white font-outfit overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12 relative z-10">
          <div className="flex-1 text-center md:text-left">
            ...
            <h1 className="text-5xl md:text-8xl font-black mb-8 leading-tight">
              <span className="text-white">Stamp Hub</span> <br />
              <span className="heading-gradient">293% Growth</span>
            </h1>
            
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl">
               {[
                 { label: 'Market Share', val: '20%', sub: 'Up from 17%', icon: Target },
                 { label: 'Monthly Rev', val: '$96K', sub: 'vs $24K baseline', icon: BarChart3 },
                 { label: 'New Products', val: '15+', sub: 'Launched & Ranked', icon: Package },
                 { label: 'Partner Since', val: '2022', sub: '3+ Years Growth', icon: Calendar },
               ].map((m, i) => (
          ...
          <div className="flex-1 relative hidden lg:block">
             <div className="relative z-10 bg-dark-bg p-8 rounded-[40px] border border-white/10 shadow-2xl overflow-hidden">
                ...
                <img 
                  src="https://images.unsplash.com/photo-1586281380349-632531db7ed4?q=80&w=600&h=400&auto=format&fit=crop" 
                  alt="Stamp Hub Case Study" 
                  className="w-full h-64 object-cover rounded-3xl mb-8 grayscale hover:grayscale-0 transition-all duration-700 hover:scale-105"
                />
        ...
        <div className="flex-[2]">
          <section className="reveal-section mb-20">
            ...
            <p className="text-lg leading-relaxed text-gray-400 max-w-4xl">
              Stamp Hub is quickly becoming a leader in high-quality materials and used tech integrated technology and 
              premium print-on-demand for corporations. Their personalized products are designed time to help protect 
              their business customers and organizations and make impressionable terms.
            </p>
          </section>
          ...
          <section className="reveal-section mb-24 p-1 rounded-[40px] bg-gradient-to-b from-white/5 to-transparent border border-white/10">
            <div className="p-8 md:p-12">
              ...
              <p className="text-gray-500 mb-12 max-w-xl">Multiple tools and strategy interactions allowed us to achieve our long-term goals for Stamp Hub.</p>
        ...
        <div className="flex-1">
          <div className="sticky top-32 space-y-8">
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-4 border-t border-white/5 pt-8">
                   <div>
                      ...
                      <p className="text-xs font-bold text-white">Rubber Stamp</p>
                   </div>
                   <div>
                      <p className="text-[10px] font-black uppercase text-gray-500 mb-1">State</p>
                      <p className="text-xs font-bold text-white">New Jersey, USA</p>
                   </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-primary-500 to-orange-600 p-6 rounded-2xl relative overflow-hidden group/cta">
                   ...
                   <p className="text-[10px] font-black text-white/80 uppercase mb-1">MAG Strategic Partner</p>
                   <p className="text-lg font-black text-white mb-3">Stamp Hub</p>
            ...
            <div className="p-6 rounded-2xl bg-[#a8cf45]/5 border border-green-500/20 text-center">
               <p className="text-xs font-bold text-[#a8cf45] mb-1 italic">"We've achieved sustained scale with MAG."</p>
               <p className="text-[10px] text-gray-500 font-black uppercase">Stamp Hub Founding Team</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end gap-12 mb-20 text-center md:text-left">
            <div>
              ...
              <p className="text-gray-400 text-lg max-w-xl">
                 Significant data interactions allowed us to achieve our goals with Stamp Hub. 
                 Growth reached <span className="text-white font-bold">293% within the first year</span> of management.
              </p>
            </div>
            <div className="flex gap-4">
               <div className="p-6 rounded-2xl bg-white/5 border border-white/10 text-center">
                  <p className="text-3xl font-black text-green-400 tracking-tight">$96,804</p>
                  <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest mt-1">Current Revenue</p>
               </div>
               <div className="p-6 rounded-2xl bg-white/5 border border-white/10 text-center">
                  <p className="text-3xl font-black text-primary-500 tracking-tight">$24,630</p>
      ...
      {/* CTA Section */}
      <section className="py-40 text-center bg-dark-bg px-6 relative overflow-hidden">
