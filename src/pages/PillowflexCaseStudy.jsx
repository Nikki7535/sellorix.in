...
const PillowflexCaseStudy = () => {
  ...
  const tabs = [
    { 
      id: 'Year 1', 
      title: 'Year 1', 
      content: '2022 - Foundational Account Restoration: MAG began account recovery by fixing catalog errors, improving brand consistency, and working with account health to set a strong foundation for growth. Overhauled SEO and listing rank. Implemented initial Design strategy for A+ content.' 
    },
    { 
      id: 'Year 2', 
      title: 'Year 2', 
  ...
  const challenges = [
    ...
    "Limited Buy Box Control: Pillowflex struggled to maintain Buy Box share on key SKUs.",
    ...
    "Product Image and Content Inefficiencies: Amazon rejection of images weakened listing conversion and shopper trust."
  ];
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12 relative z-10">
          <div className="flex-1 text-center md:text-left">
            ...
            <h1 className="text-5xl md:text-8xl font-black mb-8 leading-tight tracking-tighter">
               Pillow<span className="heading-gradient">flex</span>
            </h1>
          ...
          <div className="relative group perspective-1000 hidden lg:block stat-card">
            <div className="w-72 bg-dark-surface p-5 rounded-[32px] shadow-2xl border border-white/10 transform transition-all duration-700 hover:rotate-y-12">
              ...
              <img 
                src="https://images.unsplash.com/photo-1584132967334-10e028bd69f7?q=80&w=400&h=400&auto=format&fit=crop" 
                alt="Pillowflex Product" 
              ...
              <h4 className="text-sm font-bold leading-tight mb-4 text-white/90">Premium Synthetic Down Pillow Insert - 18x18 Square Soft Decor</h4>
        ...
        <div className="flex-[2]">
          <section className="reveal-section mb-20" id="introduction">
            ...
            <p className="text-lg leading-relaxed text-gray-400 max-w-3xl mb-6">
              Pillowflex is a family-owned, Georgia-based company with over 35 years of experience. The business 
              takes pride in its high-quality American manufacturing and its vision to distribute the best 
              pillows in the country.
            </p>
            <p className="text-lg leading-relaxed text-gray-400 max-w-3xl">
              The company has vision on creating high-end products at affordable prices, with the belief that this 
              produces more than pillows—it's a lifestyle. Pillowflex can also create custom pillows for home 
          ...
          <div className="sticky top-32 space-y-8">
            <div className="p-10 rounded-[40px] bg-dark-surface border border-white/10 shadow-3xl">
              <div className="mb-12 text-center pb-8 border-b border-white/5">
                 <h3 className="text-4xl font-black text-white tracking-tighter underline decoration-primary-500/30">PILLOWFLEX</h3>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="pt-8 border-t border-white/5 grid grid-cols-2 gap-y-6">
                   <div>
                      ...
                      <p className="text-xs font-bold text-white">Home Decor</p>
                   </div>
                   <div>
                ...
                <div className="pt-8 border-t border-white/5">
                   ...
                   <div className="p-6 rounded-2xl bg-white/5 border border-white/5 italic text-sm text-gray-400 leading-relaxed font-medium">
                      "MAG corrected catalog errors and implemented high-impact SEO, driving a 50% increase in sales volume."
                   </div>
                </div>
              </div>
            </div>
      ...
      <section className="reveal-section py-32 bg-dark-surface/50 border-y border-white/5" id="impact">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-20">
             ...
             <p className="text-xl text-gray-400 max-w-2xl mx-auto">Remarkable jump in sales volume and profitability post-MAG management.</p>
          </div>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            {/* Chart 1: Revenue increase */}
            <div className="p-10 rounded-[40px] bg-dark-bg border border-white/10">
              <h3 className="text-2xl font-black text-white mb-4">Pillowflex Amazon Sales</h3>
              ...
              <div className="mt-16 bg-white/5 p-6 rounded-3xl border border-white/10 border-dashed">
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                       ...
                       <p className="text-xs text-gray-500">MAG's strategy focused on Pillowflex's bestsellers to maximize return and scale order value.</p>
                    </div>
                 </div>
              </div>
            </div>
      ...
      <section className="py-40 text-center bg-dark-bg relative overflow-hidden px-6">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-xl text-gray-400 mb-16 max-w-2xl mx-auto font-medium">
            Join brands like Pillowflex that have achieved sustained, data-driven growth with My Amazon Guy.
          </p>
...
export default PillowflexCaseStudy;
